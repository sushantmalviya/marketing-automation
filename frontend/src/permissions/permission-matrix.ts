...
export type ModuleKey = "dashboard" | "admins" | "users" | "analytics" | "audiences" | "automations" | "campaigns" | "channels" | "communications" | "content" | "customers" | "forms" | "templates" | "assets";
...
export function getDashboardPath(role: UserRole) { return role === ROLES.ADMIN ? "/admin/dashboard" : "/user/dashboard"; }
export function roleFromPath(value: string): UserRole | null { return value === "admin" ? ROLES.ADMIN : value === "user" ? ROLES.USER : null; }
