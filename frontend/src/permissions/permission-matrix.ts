...
export type ModuleKey = "dashboard" | "admins" | "users" | "analytics" | "audiences" | "automations" | "campaigns" | "channels" | "communications" | "content" | "customers" | "forms" | "tasks" | "templates" | "assets";
